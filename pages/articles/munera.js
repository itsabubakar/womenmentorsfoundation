    ...
    return (
        <section>
            <div className="max-w-5xl mx-auto px-5 lg:px-0 py-10">
                ...
                <p className="pb-4">The purpose of the visit transcended mere formality; it was a heartfelt acknowledgment of Tanimu's significant contributions in the realm of empowering women and girls throughout the nation. As a beacon of leadership and advocacy, Tanimu's commitment has not gone unnoticed, and the prestigious Honorary Fellow Award stands as a testament to the impact she has made in her role.</p>
