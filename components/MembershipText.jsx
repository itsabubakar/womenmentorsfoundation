        ...
        <div className="mb-24">
            <section className="grid justify-center">
                <div className="max-w-3xl my-20 grid">
                    <h2 className="text-3xl text-center font-medium leading-[40px]">We help activists, advocates, specialists, and organizations by amplifying their voices. </h2>
                    <div className="max-w-xl leading-8 justify-self-center mt-4">
            ...
            <section className="flex gap-x-10 mx-20">
                <div className="h-[420px] border-4 px-8 py-10 border-gray-400 text-center">
