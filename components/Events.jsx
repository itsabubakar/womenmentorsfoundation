        ...
        <div className="flex justify-center mt-24 mx-5 sm:mx-0">
            <div className="xl:flex-row xl:max-w-2xl flex flex-col items-center">
                ...
                <div className="mt-5 xl:ml-10 w-60 sm:w-full">
                    <Link href={'/awards'}><h2 className="mb-6 xl:mb-0 cursor-pointer underline decoration-Moody-blue underline-offset-[9px] text-center text-2xl text-gray-800 hover:decoration-Sail">AWARD CEREMONY FOR WOMEN POLITICAL ASPIRANTS</h2></Link>

                    <p className="mb-2 text-sm text-gray-700 text-center xl:text-left">26th November, 2022 | 10AM | Unity Hall, Halal Hotel</p>
