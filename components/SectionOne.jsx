...
const SectionOne = () => {
    return (
        <div className="flex mt-20">
            <Article img={`https://images.unsplash.com/photo-1573167627769-e201a7ddf409?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=869&q=80`} title={'Women making difference in their workplace'} author={'Grace Jacobs'} />
