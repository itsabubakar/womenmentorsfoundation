        ...
        <div className="">
            <section className="grid justify-center">
                <div className="max-w-3xl my-20 justify-self-center">
                    <h2 className="text-3xl text-center font-medium leading-[40px]">Women Mentors Foundation is the platform for aspiring women looking to kick start their adventures.</h2>

                    {/* About */}

                    <div className="grid justify-center mt-8">
                        <div className="max-w-xl leading-8">
            ...
            <section>
                ...
                <div className="bg-Sail flex justify-center py-14">
                    <div className="max-w-6xl grid grid-cols-2 gap-x-20 gap-y-24 text-center">
                        <div>
